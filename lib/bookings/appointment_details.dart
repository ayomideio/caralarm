...
class AppointmentPersonalDetails extends StatefulWidget {
  final String vehicleYear;
  final String vehicleMake;
  final String vehicleModel;
  const AppointmentPersonalDetails(
      {super.key,
  ...
  @override
  State<AppointmentPersonalDetails> createState() => _AppointmentPersonalDetailsState();
}

class _AppointmentPersonalDetailsState extends State<AppointmentPersonalDetails> {
  @override
  void initState() {
  ...
  String orderPackage = "Delivery & Installation 200 USD";
  @override
